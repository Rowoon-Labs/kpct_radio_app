...
_$UnlockImpl _$$UnlockImplFromJson(Map<String, dynamic> json) => _$UnlockImpl(
      ...
      s1Probability:
          const StringToIntConverter().fromJson(json['s1_Probability']),
      s2Probability:
          const StringToIntConverter().fromJson(json['s2_Probability']),
      s3Probability:
          const StringToIntConverter().fromJson(json['s3_Probability']),
      s4Probability:
          const StringToIntConverter().fromJson(json['s4_Probability']),
      s5Probability:
          const StringToIntConverter().fromJson(json['s5_Probability']),
    );
...
Map<String, dynamic> _$$UnlockImplToJson(_$UnlockImpl instance) =>
    <String, dynamic>{
      ...
      's1_Probability':
          const StringToIntConverter().toJson(instance.s1Probability),
      's2_Probability':
          const StringToIntConverter().toJson(instance.s2Probability),
      's3_Probability':
          const StringToIntConverter().toJson(instance.s3Probability),
      's4_Probability':
          const StringToIntConverter().toJson(instance.s4Probability),
      's5_Probability':
          const StringToIntConverter().toJson(instance.s5Probability),
    };
