...
mixin _$Level {
  ...
  int get rewardEp => throw _privateConstructorUsedError; // @JsonKey(name: "Reward_Gear")
...
abstract class $LevelCopyWith<$Res> {
  ...
  $Res call({
    String id,
    @HourConverterFromString() @JsonKey(name: "Condition1") Duration condition1,
...
class _$LevelImpl extends _Level {
  const _$LevelImpl({
    ...
    @StringToIntConverter() @JsonKey(name: "Limit_SSP") required this.limitSsp,
    @StringToIntConverter()
    @JsonKey(name: "Reward_SSP")
    ...
    @StringToIntConverter() @JsonKey(name: "Reward_EP") required this.rewardEp,
...
abstract class _Level extends Level {
  const factory _Level({
    ...
    @StringToIntConverter()
    @JsonKey(name: "Limit_Probability")
    required final int limitProbability,
  }) = _$LevelImpl;
