                                    ...
                                    if (user.stamina > 0) {
                                      ...
                                      return StreamBuilder(
                                        ...
                                        builder: (context, snapshot) {
                                          final remaining =
                                              user.remainingStaminaRechargeDuration;
                                          final rechargeText =
                                              remaining != null
                                                  ? "충전까지 ${remaining.formatHMS(separator: ":")}"
                                                  : "0/${user.adjustedStaminaMax}";
                              ...
                              BlocBuilder<ListeningPodBloc, ListeningPodState>(
                                ...
                                builder:
                                    (context, state) => AnimatedOpacity(
                                      ...
                                      curve: Curves.easeInOutCubicEmphasized,
                                      opacity:
                                          state.listeningRewardButtonPressed
                                              ? 0.4
                                              : 1,
                                      child: KpctSwitcher(
                                        builder:
