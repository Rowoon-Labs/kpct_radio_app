...
part of 'bottom_navigation_rail_bloc.dart';
...
class _$mockImpl implements _mock {
  ...
  @override
  String toString() {
    return 'BottomNavigationRailEvent.mock()';
  }
...
abstract class _mock implements BottomNavigationRailEvent {
  const factory _mock() = _$mockImpl;
}

/// @nodoc
mixin _$BottomNavigationRailState {}
...
class _$BottomNavigationRailStateImpl implements _BottomNavigationRailState {
  const _$BottomNavigationRailStateImpl();

  @override
  String toString() {
    return 'BottomNavigationRailState()';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BottomNavigationRailStateImpl);
  }
...
abstract class _BottomNavigationRailState implements BottomNavigationRailState {
  const factory _BottomNavigationRailState() = _$BottomNavigationRailStateImpl;
}
